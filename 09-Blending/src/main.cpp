...
void applicationLoop() {
	...
	while (psi) {
		...
		//Modelo Hierba
		glDisable(GL_CULL_FACE);	//Funcion para recorte de caras ocultas
		...
		modeloHierba.render();
		glEnable(GL_CULL_FACE);		//Habilita recorte de caras ocultas

		//Orden para blending d eobjetos
		//No objetos sólidos
		...
		//Primero renderizar el skybox y después los demás objetos sólidos con transparencia
